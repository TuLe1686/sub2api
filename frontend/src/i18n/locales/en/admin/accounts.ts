export default {
    accounts: {
      ...
      codexDiagnosticDialog: {
        ...
        "noKey": "No eligible API keys owned by you",
        "noModels": "No models are available for checking",
        "keysError": "Could not load API keys",
        "modelsError": "Could not load models",
        "error": "Operation failed",
        "chooseModels": "Select models to check",
        "modelHint": "Select multiple models. Checks run in selection order.",
        ...
        "start": "Check {count} models",
        "cancel": "Cancel remaining checks",
        "retest": "Back to retest",
        "viewResults": "View last results",
        "paid": "Normal billing applies; models run one at a time",
        "selectFirst": "Select at least one model",
        "cancelHint": "Completed results are kept after cancellation",
        "keepResults": "Adjust your selection and keep these results until the next run",
        "runningTitle": "Check in progress",
        "running": "In progress",
        "finished": "Completed",
        "cancelled": "Cancelled",
        "runContext": "{count} models · One at a time",
        "billingKey": "Billing key",
        "checking": "Checking {model}",
        "finishedSummary": "This check has ended",
        "stoppedSummary": "Remaining checks stopped",
        "completed": "{done} / {total} completed",
        "progress": "Check progress",
        "individualResults": "Results by model",
        "expandHint": "Expand a result for details",
        "showDetails": "View details for {model}",
        "hideDetails": "Hide details for {model}",
