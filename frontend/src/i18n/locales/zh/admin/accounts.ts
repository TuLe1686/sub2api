export default {
    accounts: {
      codexDiagnosticDialog: {
        ...
        "setup": "选择模型",
        "results": "检测结果",
        "viewResultsStep": "查看结果",
        "settings": "检测设置",
        "key": "用于计费的 API Key",
        "chooseKey": "选择 API Key",
        "keyHint": "通过当前账号发起检测，使用所选 Key 正常计费。",
        "info": "检测信息",
        "templateHint": "使用系统设置中的「Codex 打票与降智检测模板」。",
        "fingerprint": "指纹库版本",
        "updateBank": "更新指纹库",
        "retry": "重试加载",
        "loadingKeys": "正在加载 API Key…",
        "loadingModels": "正在加载检测模型…",
        "noKey": "没有可用的本人 API Key",
        "noModels": "当前没有可检测的模型",
        "keysError": "API Key 加载失败",
        "modelsError": "检测模型加载失败",
        "error": "操作失败",
        "chooseModels": "选择检测模型",
        "modelHint": "支持多选，按选择顺序逐个检测。",
        "selected": "已选 {count}",
        "modelCount": "共 {count} 个可检测模型",
        "matchedCount": "找到 {count} 个模型",
        "clear": "清空选择",
        "search": "搜索模型名称",
        "models": "可检测模型",
        "emptySearch": "没有匹配的模型，试试其他关键词。",
        "order": "检测顺序 {index}",
        "start": "开始检测（{count} 个模型）",
        "cancel": "取消后续检测",
        "retest": "返回重测",
        "viewResults": "查看上次结果",
        "paid": "按正常请求计费，检测逐项进行",
        "selectFirst": "请选择至少一个模型",
        "cancelHint": "取消后保留已完成的检测结果",
        "keepResults": "返回后可调整选择，本次结果仍会保留",
        "runningTitle": "检测进行中",
        "running": "进行中",
        "finished": "已完成",
        "cancelled": "已取消",
        "runContext": "{count} 个模型 · 串行检测",
        "billingKey": "计费 Key",
        "checking": "正在检测 {model}",
        "finishedSummary": "本次检测已结束",
        "stoppedSummary": "后续检测已停止",
        "completed": "{done} / {total} 已完成",
        "progress": "检测进度",
        "individualResults": "逐项结果",
        "expandHint": "展开查看检测详情",
        "showDetails": "查看 {model} 的详情",
        "hideDetails": "收起 {model} 的详情",
        "prediction": "预测模型",
        "probability": "匹配概率",
        "reason": "原因",
        "gateway": "网关响应",
      ...
      openai: {
        ...
        codexTicketHistory: '票据与流水',
        codexTicketSummary: '可用票 {ready} / 参与模型 {total}',
        codexTicketReadyShort: '可用',
        codexTicketMissingShort: '无票',
        codexTicketEventSuccess: '打票成功',
        codexTicketEventMiss: '打票未命中',
        codexTicketEventError: '打票错误',
        codexTicketEventInvalidation: '票据失效',
